...
class JavascriptParser extends Parser {
	...
	walkTerminatingStatement(statement) {
		...
		if (this.scope.executedPath && this.hooks.terminate.call(statement)) {
			this.scope.returned = true;
		}
	}
	...
	inExecutedPath(state, fn) {
		...
		if (state && oldScope.executedPath) {
			oldScope.returned = this.scope.returned;
		}
	...
	inBlockScope(fn, executedPath) {
		...
		if (executedPath && oldScope.executedPath) {
			oldScope.returned = this.scope.returned;
		}
